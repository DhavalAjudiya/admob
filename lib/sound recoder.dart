...
//       flags: 0,
//       route: (_) => Demo(),
//       description: '''This is a Demo of what it is possible to do with Flutter Sound.
...
//     description: '''A very simple example showing how to play Live Data without back pressure.
...
//                 ),
//               ),
//               child: ListView.builder(itemCount: exampleTable.length, itemBuilder: cardBuilder),
//             ),
//           ),
//           Expanded(
//             child: Container(
...
//                 ElevatedButton(
//                   onPressed: (kIsWeb && (selectedExample!.flags! & tNotWeb != 0)) ? null : () => selectedExample!.go(context),
//                   //color: Colors.indigo,
//                   child: Text(
//                     'GO',
