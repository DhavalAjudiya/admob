...
void main() {
  runApp(const ImagePazzal());
}

class ImagePazzal extends StatelessWidget {
  const ImagePazzal({Key? key}) : super(key: key);
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                JigsawPuzzle(
                  autoStart: true,
                  gridSize: 2, outlineCanvas: true,
                  image: const AssetImage('asset/image/category.png'),
                  onFinished: () {
                    // ignore: avoid_print
                    print('finished!');
                  },
