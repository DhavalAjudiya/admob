...
class SfMap extends StatefulWidget {
  const SfMap({Key? key}) : super(key: key);

  @override
  State<SfMap> createState() => _SfMapState();
}

class _SfMapState extends State<SfMap> {
            ...
            layers: <MapShapeLayer>[
              MapShapeLayer(
                ...
                dataLabelSettings: MapDataLabelSettings(
                    textStyle: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: Theme.of(context).textTheme.caption!.fontSize)),
              ),
            ],
          ),
        ),
