...
class _NearByPlacesScreenState extends State<NearByPlacesScreen> {
  String apiKey = "AIzaSyDdm-Ywb7OBY-aehPYvhYKiZZjIDn4kRAM";
  String radius = "30";
        ...
        child: Column(
          children: [
            ...
            if (nearbyPlacesResponse.results != null)
              for (int i = 0; i < nearbyPlacesResponse.results!.length; i++) nearbyPlacesWidget(nearbyPlacesResponse.results![i])
          ],
        ),
      ),
    );
  ...
  void getNearbyPlaces() async {
    var url = Uri.parse('https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=33.68060824514047,73'
        '.0151709698594&radius=1500&type=restaurant,hospital&key=$apiKey');
